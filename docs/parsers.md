# 🧠 Configurador de Parsers — Guía Completa

> Esta guía estaba ubicada en `GUIA_PARSER.md`. Se ha movido aquí para mantener la documentación centralizada.
...
1. Abre LogScope en tu navegador ([http://localhost:5173](http://localhost:5173) en modo dev)
